...
In this section, the results obtained from the experiments have been presented. \ref{table 1} shows the accuracy of face recognition for each of the methods. For each method, the system was trained on unaltered LFW data. Each system was then tested under both unoccluded and occluded conditions. 
These results vary with a margin of 3%.

From the results, it shows that convolutional neural networks have the highest accuracy while k nearest neighbours algorithm has the lowest accuracy of prediction.
